...
- ミューテーションテスト: モード gate / advisory、調整後スコア N%（生 N% / 閾値 N%）、生存 N 件（killed n / equivalent n / accepted n / untriaged n）／ 未実行（理由: not_configured / low_risk / out_of_scope / mode_off / empty_scope）（`mutation`）
