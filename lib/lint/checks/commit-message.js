...
/** Base refs searched, in order, for the merge-base of the current branch */
const BASE_REFS = [
  'origin/main',
  'main',
  'origin/master',
...
module.exports = {
  name: 'commit-message',
  // Optional per catalog C7: off by default, enabled per adoption by the
  // lint-scaffolding config.
